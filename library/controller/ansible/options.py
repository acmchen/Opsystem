...
class Manager_Option(Base):
    def init_parm(self, username):
        self.ansi_option_mongocollect = username +'.ansible.option'
        self.ansi_option_rediskey = 'devops:' + username + ':ansible:option'
    ...
    def get_default(self, username, field, isall=True, exe_mode=''):
        ...
        redis_key = 'devops:' + username + ':ansible:option:default:' + exe_mode + ':' + field + ':' + str(isall)
