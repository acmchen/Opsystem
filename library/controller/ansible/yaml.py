...
class Manager_Yaml(Base):
    def __init__(self, username, vault_passwd=None, mongoclient=None, redisclient=None):
        ...
        self.yaml_rediskey_prefix = 'devops:' + username + 'ansible:yaml:'
    ...
    def import_path(self, this_path, name, yaml_tpye='main', file_type='tasks', describe=''):
        ...
        if yaml_tpye == 'roles' :
            if os.path.isdir(this_path) :
                ...
                roles_path = '/dev/shm/devops/ansible/yaml/' + random_str(ranlen=16)
            ...
            if os.path.isdir(this_path) :
                ...
                if result[1] == 'txt' :
                    ...
                    dest_dir = '/dev/shm/devops/ansible/yaml/' + random_str(ranlen=16)
