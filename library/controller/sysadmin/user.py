...
# from library.controller.sysadmin.privacy import Manager_Privacy
...
class Manager_User(Base):
    ...
    def create(self, user_mess_dict):
        ...
        old_user_dict = self.get_userinfo(force=True,username=username)
        ...
        if 'level' in user_mess_dict :
            level = user_mess_dict['level']
        else:
            level = 0
