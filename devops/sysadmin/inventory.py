...
class Inventory(Base):
    ...
    def detail(self, request):
        ...
        if result[0] :
            ...
            return render(request, 'inve_detail.html', {'name':name, 'detail_dict':result[1],'host_status':result[2] , 'login_user':username, 'nav_html':self.nav_html, 'lately_whereabouts':self.latelywhere_html})
        else :
