...
from devops.ansible.execute import Exec
from devops.ansible.options import Options
from devops.ansible.report import Report
from devops.ansible.yaml import Yaml
from devops.sysadmin.inventory import Inventory
# from devops.sysadmin.privacy import Privacy
from devops.sysadmin.user import User
from devops.views import Login
...
urlpatterns = [
    ...
    url(r'^$', Inventory(mongoclient=mongoclient, redisclient=redisclient).summary, name='index'),
